...
urlpatterns = [
    path('payment(?P<total>[0-9]+)/(?P<razorpay_order_id>[0-9]+)', payment, name='payment'),
    path("callback/",callback, name="callback"),
    path('forget-password/' , ForgetPassword , name="forget_password"),
    path('reset-password/<token>/' , ResetPassword , name="reset_password"),
    path('admin/', admin.site.urls),
    path('',Home,name="home"),
    path('signup',Signup,name="signup"),
    path('verify-account/<token>/' , VerifyAccount , name="verify_account"),
    ...
    path('add_blogpost',add_blogpost,name="add_blogpost"),
    path('view_blogpost',view_blogpost,name="view_blogpost"),
    path('change_password',Change_Password, name="change_password"),
    path('delete_blogpost/<int:pid>',delete_blogpost,name="delete_blogpost"),
    path('edit_blogpost/<int:pid>',edit_blogpost, name='edit_blogpost'),
    path('blogs',blogs,name="blogs"),
    path('blogdetail/<int:pid>',blogdetail, name='blogdetail'),
